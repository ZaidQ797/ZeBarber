export {wp, hp, Size} from './styling/responsive';
export {appImages, appIcons, appSvgs, appLogo} from './assets';
...
export {signUpValdation, loginValidation, dummyArticles} from './constants';
export {
  StatusBarHeight,
